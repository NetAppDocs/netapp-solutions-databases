...
image:aws-postgres-fsx-ec2-architecture.png["This image provides a detailed picture of the organization of the PostgreSQL hybrid cloud solution, including the on-premises side and the AWS site."]
...
. Set up the Ansible controller as described in the section "Set up the Ansible Control Node for CLI deployments on RHEL/CentOS" from the resource link:https://docs.netapp.com/us-en/netapp-solutions-dataops/automation/getting-started.html[Getting Started with NetApp solution automation^]. 
...
include::../_include/aws-postgres-fsx-ec2-host-vars.adoc[]

=== Configure the global fsx_vars.yml file in the vars folder

include::../_include/aws-postgres-fsx-ec2-fsx-vars.adoc[]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_postgres_fsx_ec2_hadr.adoc
