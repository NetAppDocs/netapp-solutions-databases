...
To learn more about the NetApp solution automation, review the following website link:https://docs.netapp.com/us-en/netapp-solutions-dataops/automation/automation-introduction.html[NetApp Solution Automation^^]


// NetApp Solutions restructuring (jul 2025) - renamed from databases/automation_ora_clone_lifecycle.adoc
