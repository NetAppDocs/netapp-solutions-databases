...
image:automation-ora-asa-iscsi-architecture.png["This image provides a detailed picture of the Oracle deployment configuration in NetApp ASA system with iSCSI and ASM."]
...
+
include::../_include/automation-ora-asa-iscsi-hosts.adoc[]

. Global `vars/vars.yml` file configuration
+
include::../_include/automation-ora-asa-iscsi-vars.adoc[]
...
+
image:automation-ora-asa-em-001.png["This image provides login screen for Oracle Enterprise Manager Express"]
image:automation-ora-asa-em-002.png["This image provides container database view from Oracle Enterprise Manager Express"]
+
....
...
....
+
image:automation-ora-asa-em-003.png["This image provides PDB database view from Oracle Enterprise Manager Express"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/automation_ora_asa_iscsi.adoc
