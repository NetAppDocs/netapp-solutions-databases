...
. For detailed instructions for obtaining the keys and tokens necessary for the CVO Data Protection visit link:https://docs.netapp.com/us-en/netapp-solutions-dataops/automation/authentication-tokens.html[Gather Pre-requisites For CVO and Connector Deployments^]
...
After you are ready, click link:db-protection-awx-automation.html[here for detailed AWX/Tower procedures].


// NetApp Solutions restructuring (jul 2025) - renamed from databases/db_protection_getting_started.adoc
