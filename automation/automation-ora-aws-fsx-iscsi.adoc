...
image:automation-ora-aws-fsx-iscsi-architecture.png["This image provides a detailed picture of the Oracle deployment configuration in AWS public cloud with iSCSI and ASM."]
...
+
include::../_include/automation-ora-aws-fsx-iscsi-hosts.adoc[]

. Global `vars/vars.yml` file configuration
+
include::../_include/automation-ora-aws-fsx-iscsi-vars.adoc[]

. Local DB server `host_vars/host_name.yml` configuration such as ora_01.yml, ora_02.yml ...
+
include::../_include/automation-ora-asa-iscsi-host-vars.adoc[]
...
+
image:automation-ora-aws-fsx-iscsi-em-001.png["This image provides login screen for Oracle Enterprise Manager Express"]
image:automation-ora-aws-fsx-iscsi-em-002.png["This image provides container database view from Oracle Enterprise Manager Express"]
image:automation-ora-aws-fsx-iscsi-em-003.png["This image provides container database view from Oracle Enterprise Manager Express"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/automation_ora_aws-fsx_iscsi.adoc
