...
+
image:sql-awsec2-001.png["Figure showing input/output dialog or representing written content"]

. Specify the password for fsxadmin.
+
image:sql-awsec2-002.png["Figure showing input/output dialog or representing written content"]

. Specify the password for SVMs.
+
image:sql-awsec2-003.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-004.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-005.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-008.png["Figure showing input/output dialog or representing written content"]

. Repeat step 12 for the second iSCSI IP from the SVM.
+
. Select the *Targets* tab,  select *Connect*,  and select *Enable muti-path*.
+
image:sql-awsec2-009.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-010.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-011.png["Figure showing input/output dialog or representing written content"]
...
....
+
image:sql-awsec2-012.png["Figure showing input/output dialog or representing written content"]
...
image:sql-awsec2-013.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-014.png["Figure showing input/output dialog or representing written content"]

. Add the storage system by selecting Storage Systems > New and the provide the appropriate FSx ONTAP storage information.
+
image:sql-awsec2-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-017.png["Figure showing input/output dialog or representing written content"]
+
If the LUNs have already been provisioned, you can select the mount point to represent the host log directory.
+
image:sql-awsec2-018.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:sql-awsec2-019.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-021.png["Figure showing input/output dialog or representing written content"]

. Click *Back up Now* to test the backup. In the pop- up windows, select *Backup*.
+
image:sql-awsec2-022.png["Figure showing input/output dialog or representing written content"]

. Select *Monitor* to verify that the backup has been completed.
+
image:sql-awsec2-023.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-024.png["Figure showing input/output dialog or representing written content"]
...
+
image:sql-awsec2-025.png["Figure showing input/output dialog or representing written content"]
====
...
+
image:sql-awsec2-026.png["Figure showing input/output dialog or representing written content"]
...
. Select Monitor to make sure that cloning is completed.
+
image:sql-awsec2-027.png["Figure showing input/output dialog or representing written content"]
=====
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/sql-aws-ec2.adoc
