...
image:customer-usecase-mssql-fsx1-before.png["This image provides a detailed picture of the customer env configuration before migration."]
...
image:customer-usecase-mssql-fsx1-after.png["This image provides a detailed picture of the customer env configuration after migration."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/customer_usecase_mssql_fsx1.adoc
