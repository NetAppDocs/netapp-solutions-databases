...
+
image::gcnv-sql-aoag-006.png[Create a Shared Folder Wizard]
...
+
image::gcnv-sql-aoag-007.png[Configure Cluster Quorum Settings menu]
...
image::gcnv-sql-aoag-008.png[Cluster quorum configured with file share witness]
...
+
image::gcnv-sql-aoag-009.png[Enable Always On High Availability]
...
image::gcnv-sql-aoag-010.png[Create availability group wizard]

image::gcnv-sql-aoag-011.png[Add database and replicas to availability group]

image::gcnv-sql-aoag-012.png[Availability group synchronization]

image::gcnv-sql-aoag-013.png[Availability group created successfully]
...
+
image::gcnv-sql-aoag-014.png[DNN resource properties]

. Clear the checkbox for any nodes that don't participate in the availability group.
+
image::gcnv-sql-aoag-015.png[Configure DNN possible owners]
...
image::gcnv-sql-aoag-016.png[Verify availability group configuration and synchronization]
...
image::gcnv-sql-aoag-017.png[Always On High Availability dashboard showing successful failover]
