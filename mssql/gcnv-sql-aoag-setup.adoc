...
The SQL Server Always On availability group configuration workflow covers the following tasks:
...
Open required ports on both SQL nodes for cluster communication. For detailed firewall requirements, refer to link:https://learn.microsoft.com/en-us/troubleshoot/windows-server/high-availability/service-overview-and-network-port-requirements[Windows Server service and network port requirements^].
