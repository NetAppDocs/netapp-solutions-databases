...
summary: This section describes the different issues you should consider when using Azure NetApp Files with SQL Server in the cloud.
---
= Factors to consider
:hardbreaks:
:nofooter:
...
* The following UNC paths are supported: `\\ANFSMB-b4ca.anf.test\SQLDB` and `\\ANFSMB-b4ca.anf.test\SQLDB\`.
...
image:sql-srv-anf-001.png["Figure showing input/output dialog or representing written content"]
...
image:sql-srv-anf-002.png["Figure showing input/output dialog or representing written content"]
...
image:sql-srv-anf-003.png["Figure showing input/output dialog or representing written content"]
...
image:sql-srv-anf-004.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/sql-srv-anf_factors_to_consider.adoc
