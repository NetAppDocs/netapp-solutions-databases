...
image:aws-ora-fsx-ec2-inst-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-006.png["Figure showing input/output dialog or representing written content"]

. In Step 5, add a tag for instance identification if needed.
+
image:aws-ora-fsx-ec2-inst-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-inst-009.png["Figure showing input/output dialog or representing written content"]
image:aws-ora-fsx-ec2-inst-009-a.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-rds-custom-deploy-fsx-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-stor-001.png["Figure showing input/output dialog or representing written content"]

. Select Amazon FSx ONTAP. Then click Next.
+
image:aws-ora-fsx-ec2-stor-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-stor-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-stor-004.png["Figure showing input/output dialog or representing written content"]

. In the Security & Encryption section, accept the default, and enter the fsxadmin password.
+
image:aws-ora-fsx-ec2-stor-005.png["Figure showing input/output dialog or representing written content"]

. Enter the SVM name and the vsadmin password.
+
image:aws-ora-fsx-ec2-stor-006.png["Figure showing input/output dialog or representing written content"]

. Leave the volume configuration blank; you do not need to create a volume at this point.
+
image:aws-ora-fsx-ec2-stor-007.png["Figure showing input/output dialog or representing written content"]

. Review the Summary page, and click Create File System to complete FSx file system provision.
+
image:aws-ora-fsx-ec2-stor-008.png["Figure showing input/output dialog or representing written content"]
...
image:aws-ora-fsx-ec2-stor-009.png["Figure showing input/output dialog or representing written content"]
image:aws-ora-fsx-ec2-stor-010.png["Figure showing input/output dialog or representing written content"]
image:aws-ora-fsx-ec2-stor-011.png["Figure showing input/output dialog or representing written content"]
...
See these detailed instruction link:../automation/cli-automation.html[CLI deployment Oracle 19c Database^] to deploy Oracle 19c with CLI automation. There is a small change in command syntax for playbook execution because you are using an SSH key pair instead of a password for host access authentication. The following list is a high level summary:
...
+
image:aws-ora-fsx-ec2-stor-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-rds-custom-deploy-snp-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-rds-custom-deploy-snp-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-rds-custom-deploy-snp-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-rds-custom-deploy-snp-004.png["Figure showing input/output dialog or representing written content"]
+
Check Oracle Database, and, before you submit, click More Options.
+
image:aws-rds-custom-deploy-snp-005.png["Figure showing input/output dialog or representing written content"]
+
Check Skip Preinstall Checks. Confirm Skipping Preinstall Checks, and then click Submit After Save.
+
image:aws-rds-custom-deploy-snp-006.png["Figure showing input/output dialog or representing written content"]
+
You are prompted with Confirm Fingerprint, and then click Confirm and Submit.
+
image:aws-rds-custom-deploy-snp-007.png["Figure showing input/output dialog or representing written content"]
+
After successful plugin configuration, the managed host's overall status show as Running.
+
image:aws-rds-custom-deploy-snp-008.png["Figure showing input/output dialog or representing written content"]

=== Configure backup policy for Oracle database

Refer to this section link:../dbops/hybrid-dbops-sc-gs-onprem.html#7-setup-database-backup-policy-in-snapcenter[Setup database backup policy in SnapCenter^] for details on configuring the Oracle database backup policy.
...
Refer to the Oracle section of link:../dbops/hybrid-dbops-sc-gs-onprem.html#8-implement-backup-policy-to-protect-database[Implement backup policy to protect database^] for a detailed step-by-step processes for implementing the backup policy created in the section <<Configure backup policy for Oracle database>> and for backup job scheduling.

The following image provides an example of the resources groups that are set up to back up an Oracle database.

image:aws-rds-custom-deploy-snp-009.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_ora_fsx_ec2_procedures.adoc
