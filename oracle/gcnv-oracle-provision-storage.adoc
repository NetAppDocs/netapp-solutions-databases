...
== What's next?
To install Oracle Grid Infrastructure and Database binaries on prepared hosts, proceed to xref:gcnv-oracle-install-software.adoc[Install the Oracle Grid Infrastructure and Oracle Database software] on both hosts.
