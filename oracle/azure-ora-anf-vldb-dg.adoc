...
image:azure-ora-anf-vldb-dg-architecture.png["This image provides a detailed picture of the Oracle Data Guard implementation in Azure cloud on ANF."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/azure_ora_anf_vldb_dg.adoc
