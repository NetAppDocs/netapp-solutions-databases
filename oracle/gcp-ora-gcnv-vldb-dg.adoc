...
+
link:azure-ora-anf-data-guard.html#purpose[TR-5002: Oracle Active Data Guard Cost Reduction with Azure NetApp Files]

* TR-4974: Oracle 19c in Standalone Restart on AWS FSx/EC2 with NFS/ASM
+
link:aws-ora-fsx-ec2-nfs-asm.html#purpose[TR-4974: Oracle 19c in Standalone Restart on AWS FSx/EC2 with NFS/ASM]
