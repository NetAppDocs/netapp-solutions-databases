...
image:gcnv-ora-vldb-dg-architecture.png["This image provides a detailed picture of the Oracle Data Guard implementation in Google cloud on GCNV."]
...
+
image:gcnv-ora-vldb-dg-pool-001.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-pool-002.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-pool-003.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-pool-004.png["Screenshot showing GCNV environment configuration."]
...
+
image:gcnv-ora-vldb-dg-vol-001.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-vol-002.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-vol-003.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-vol-004.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-vol-005.png["Screenshot showing GCNV environment configuration."]
image:gcnv-ora-vldb-dg-vol-006.png["Screenshot showing GCNV environment configuration."]
...
* link:aws-ora-fsx-ec2-nfs-asm.html[TR-4974: Oracle 19c in Standalone Restart on AWS FSx/EC2 with NFS/ASM^]
...
+
link:https://docs.netapp.com/us-en/netapp-solutions-databases/oracle/azure-ora-anf-data-guard.html#purpose[https://docs.netapp.com/us-en/netapp-solutions/databases/azure_ora_anf_data_guard.html#purpose^]

* TR-4974: Oracle 19c in Standalone Restart on AWS FSx/EC2 with NFS/ASM
+
link:https://docs.netapp.com/us-en/netapp-solutions-databases/oracle/aws-ora-fsx-ec2-nfs-asm.html#purpose[https://docs.netapp.com/us-en/netapp-solutions/databases/aws_ora_fsx_ec2_nfs_asm.html#purpose^]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/gcp_ora_gcnv_vldb_dg.adoc
