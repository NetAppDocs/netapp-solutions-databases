...
== What's next?
To prepare your environment before deployment, continue with xref:gcnv-oracle-access-and-apis.html[Access and APIs for Oracle Database 26ai on Google Cloud NetApp Volumes].
