...
+
image:db-ora-azure-anf-vm-001.png["This screenshot shows the list of available Azure VMs."]
...
+
image:db-ora-azure-anf-vm-002-a.png["This screenshot shows the input for the Create a Virtual Machine page."]
image:db-ora-azure-anf-vm-002-b.png["This screenshot shows additional input for the Create a Virtual Machine page."]
...
+
image:db-ora-azure-anf-vm-003.png["This screenshot shows the input for the Create a Virtual Machine Disks page."]

. Choose the VNet and subnet. Allocate a public IP for external VM access. Then go to the Management page.
+
image:db-ora-azure-anf-vm-004.png["This screenshot shows further input for the Create a Virtual Machine page."]

. Keep all defaults for Management and move to the Advanced page.
+
image:db-ora-azure-anf-vm-005.png["This screenshot shows the input for the Create a Virtual Machine Management page."]
...
+
image:db-ora-azure-anf-vm-006.png["This screenshot shows the input for the Create a Virtual Machine Advanced page."]

. Add a tag for the VM if desired. Then, go to the Review + create page.
+
image:db-ora-azure-anf-vm-007.png["This screenshot shows the input for the Create a Virtual Machine Tags page."]
...
+
image:db-ora-azure-anf-vm-008.png["This screenshot shows the input for the Create a Virtual Machine review and create page".]
...
+
image:db-ora-azure-anf-vols-006.png["This screenshot shows the Azure Services page, with ANF highlighted."]

. Under your NetApp storage account, click *Volumes*, and then *Add volume* to create new Oracle volumes.
+
image:db-ora-azure-anf-vols-001-a.png["This screenshot shows the landing screen for a NetApp storage account."]
image:db-ora-azure-anf-vols-001.png["This screenshot shows the volumes available for the NetApp storage account."]
...
+
image:db-ora-azure-anf-vols-002.png["Volume creation screen."]
...
+
image:db-ora-azure-anf-vols-003.png["Protocol input on the Volume creation screen."]

. Add a volume tag if desired. Then click *Review + Create>*.
+
image:db-ora-azure-anf-vols-004.png["Tags input on the Volume creation screen."]

. If the validation passes, click *Create* to create the volume.
+
image:db-ora-azure-anf-vols-005.png["Review and create stage of the Volume creation screen."]
...
If you have not set up an Ansible controller, see link:https://docs.netapp.com/us-en/netapp-solutions-dataops/automation/automation-introduction.html[NetApp Solution Automation^^], which has detailed instructions on how to setup an Ansible controller.
...
See the link:../automation/cli-automation.html#cli-deployment-oracle-19c-database[CLI deployment Oracle 19c Database^] to execute the playbook with the CLI. You can ignore the ONTAP portion of the variables configuration in the global VARS file when you create database volumes from the Azure console rather than the CLI.
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/azure_ora_nfile_procedures.adoc
