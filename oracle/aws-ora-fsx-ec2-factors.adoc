...
+
image:aws-ora-fsx-ec2-stor-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:aws-ora-fsx-ec2-stor-013.png["Figure showing input/output dialog or representing written content"]
...
* The following table provides recommended NFS mount options for Linux - single instance.
+
image:aws-ora-fsx-ec2-nfs-001.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_ora_fsx_ec2_factors.adoc
