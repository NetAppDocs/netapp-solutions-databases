...
image:oracle-gcnv-001.png["Figure showing input/output dialog or representing written content"]
...
image:oracle-gcnv-002.png["Figure showing input/output dialog or representing written content"]
...
image:oracle-gcnv-003.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/gcp-oracle-gcnv-overview.adoc
