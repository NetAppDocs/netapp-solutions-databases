...
image:aws-ora-fsx-ec2-pcs-architecture.png["This image provides a detailed picture of Oracle HA in AWS EC2 with Pacemaker Clustering and FSx ONTAP."]
...
+
image:aws-ora-fsx-ec2-pcs-001.png["This image provides Amazon FSx ONTAP volume provisioning from AWS FSx console"]
image:aws-ora-fsx-ec2-pcs-002.png["This image provides Amazon FSx ONTAP volume provisioning from AWS FSx console"]
image:aws-ora-fsx-ec2-pcs-003.png["This image provides Amazon FSx ONTAP volume provisioning from AWS FSx console"]
image:aws-ora-fsx-ec2-pcs-004.png["This image provides Amazon FSx ONTAP volume provisioning from AWS FSx console"]
image:aws-ora-fsx-ec2-pcs-005.png["This image provides Amazon FSx ONTAP volume provisioning from AWS FSx console"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_ora_ha_pacemaker.adoc
