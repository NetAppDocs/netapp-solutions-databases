...
== What's next?
Review the end-to-end architecture and workflow in xref:gcnv-oracle-deployment.adoc[Learn about Oracle Database 26ai high availability on Google Cloud NetApp Volumes].
