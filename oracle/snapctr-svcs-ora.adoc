...
image:snapctr-svcs-architecture.png["This image provides a detailed picture of the BlueXP backup and recovery for applications within BlueXP console, including the UI, connector and resources it manages."]
...
+
image:snapctr-svcs-connector-001-policy.png["Screenshot showing this step in the GUI."]
+
...
+ 
image:snapctr-svcs-connector-002-wspace.png["Screenshot showing this step in the GUI."]

. Click *Add a Connector* to launch the connector provisioning workflow.

image:snapctr-svcs-connector-003-add.png["Screenshot showing this step in the GUI."]

. Choose your cloud provider (in this case, *Amazon Web Services*).

image:snapctr-svcs-connector-004-aws.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-connector-005-remind.png["Screenshot showing this step in the GUI."]

. Enter your AWS account authentication with *Access Key* and *Secret Key*.
+
image:snapctr-svcs-connector-006-auth.png["Screenshot showing this step in the GUI."]

. Name the connector instance and select *Create Role* under *Details*.

image:snapctr-svcs-connector-007-details.png["Screenshot showing this step in the GUI."]

. Configure networking with the proper *VPC*, *Subnet*, and SSH *Key Pair* for connector access.
+
image:snapctr-svcs-connector-008-network.png["Screenshot showing this step in the GUI."]

. Set the *Security Group* for the connector.
+
image:snapctr-svcs-connector-009-security.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-connector-010-review.png["Screenshot showing this step in the GUI."]
====
...
+
image:snapctr-svcs-credential-001-aws.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-credential-002-aws.png["Screenshot showing this step in the GUI."]

. Filter permission policies by fsx and add *Permissions policies* to the role.
+
image:snapctr-svcs-credential-003-aws.png["Screenshot showing this step in the GUI."]

. In *Role details* page, name the role, add a description, then click *Create role*.
+
image:snapctr-svcs-credential-004-aws.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-credential-005-aws.png["Screenshot showing this step in the GUI."]

. Choose credential location as - *Amazon Web Services - BlueXP*.
+
image:snapctr-svcs-credential-006-aws.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-credential-007-aws.png["Screenshot showing this step in the GUI."]

. Review and *Add*.
image:snapctr-svcs-credential-008-aws.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-setup-001.png["Screenshot showing this step in the GUI."]

. Choose *Amazon Web Services* as the location.

image:snapctr-svcs-setup-002.png["Screenshot showing this step in the GUI."]

. Click *Discover Existing* next to *Amazon FSx ONTAP*.

image:snapctr-svcs-setup-003.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-setup-004.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-setup-005.png["Screenshot showing this step in the GUI."]

. The discovered Amazon FSx ONTAP instance now appears in the working environment.

image:snapctr-svcs-setup-006.png["Screenshot showing this step in the GUI."]

. You can log into the FSx cluster with your fsxadmin account credentials.

image:snapctr-svcs-setup-007.png["Screenshot showing this step in the GUI."]

. After you log into Amazon FSx ONTAP, review your database storage information (such as database volumes). 

image:snapctr-svcs-setup-008.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-setup-009.png["Screenshot showing this step in the GUI."]

. Select *Cloud Native* as the application source type.

image:snapctr-svcs-setup-010.png["Screenshot showing this step in the GUI."]

. Choose *Oracle* for the application type.

image:snapctr-svcs-setup-013.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-setup-014.png["Screenshot showing this step in the GUI."]

. Paste in your ec2-user SSH key for the database EC2 host and click on *Validate* to proceed.
+
image:snapctr-svcs-setup-014-a.png["Screenshot showing this step in the GUI."]

. You will be prompted for *Validating fingerprint* to proceed.
+
image:snapctr-svcs-setup-014-b.png["Screenshot showing this step in the GUI."]
...
+
image:snapctr-svcs-setup-017.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-bkup-007.png["Screenshot showing this step in the GUI."]
====
...
image:snapctr-svcs-restore-001.png["Screenshot showing this step in the GUI."]
...
image:snapctr-svcs-restore-002.png["Screenshot showing this step in the GUI."]

. Review and start database restore and recovery.

image:snapctr-svcs-restore-003.png["Screenshot showing this step in the GUI."]

. From the *Job Monitoring* tab, you can view the status of the restore job as well as any details while it is running.

image:snapctr-svcs-restore-005.png["Screenshot showing this step in the GUI."]

image:snapctr-svcs-restore-004.png["Screenshot showing this step in the GUI."]
====
...
image:snapctr-svcs-clone-002.png["Figure showing input/output dialog or representing written content"]

. Select the *Basic* option if you don't need to change any cloned database parameters. 

image:snapctr-svcs-clone-003.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-svcs-clone-003-a.png["Figure showing input/output dialog or representing written content"]

. Review and launch the job.

image:snapctr-svcs-clone-004.png["Figure showing input/output dialog or representing written content"]

. Monitor the cloning job status from the *Job Monitoring* tab.

image:snapctr-svcs-clone-007-status.png["Figure showing input/output dialog or representing written content"]

. Validate the cloned database on the EC2 instance host. 

image:snapctr-svcs-clone-008-crs.png["Figure showing input/output dialog or representing written content"]

image:snapctr-svcs-clone-008-db.png["Figure showing input/output dialog or representing written content"]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/snapctr_svcs_ora.adoc
