...
== What's next?
To provide shared storage for Oracle binaries and ASM disk groups, go to xref:gcnv-oracle-provision-storage.adoc[Provision Google Cloud NetApp Volumes iSCSI pools, host groups, and volumes].
