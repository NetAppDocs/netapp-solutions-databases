...
+
image:db-sizing-ora-parser-001.png["This image provides HTML parser screen for Oracle sizing"]
...
+
image:db-sizing-ora-parser-002.png["This image provides HTML parser screen for Oracle sizing"]
...
+
image:db-sizing-ora-parser-anf-003.png["This image provides excel template screen shot for Oracle sizing"]
...
+
image:db-sizing-ora-parser-anf-004.png["This image provides excel template screen shot for Oracle sizing"]

. Check `Other`, then enter '=' as `Delimiters`. Click on `Next` to next screen.
+
image:db-sizing-ora-parser-anf-005.png["This image provides excel template screen shot for Oracle sizing"]
...
+
image:db-sizing-ora-parser-anf-006.png["This image provides excel template screen shot for Oracle sizing"]
image:db-sizing-ora-parser-anf-007.png["This image provides excel template screen shot for Oracle sizing"]
...
+
image:db-sizing-ora-parser-anf-008.png["This image provides excel template screen shot for Oracle sizing"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/db_sizing_ora_anf.adoc
