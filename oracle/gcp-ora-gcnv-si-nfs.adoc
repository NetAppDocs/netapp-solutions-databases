...
. The following log file recording is an example of the snapshot backup and retention management.
+
....
...
. The following log file recording captures the details of a vault backup from app-consistent snapshots.
+
....
