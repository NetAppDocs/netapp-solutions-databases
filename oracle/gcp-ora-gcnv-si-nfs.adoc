...
image:gcp-ora-gcnv-si-nfs-architecture.png["This image provides a detailed picture of the Oracle deployment configuration in Google Cloud with NFS and Google NetApp Volumes."]
