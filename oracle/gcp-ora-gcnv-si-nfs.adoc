...
= TR-XXXX:  Oracle Standalone Instance Deployment on Google NetApp Volumes over NFS
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
This solution provides overview and details for automated Oracle deployment in Google NetApp Volumes as primary database storage with NFS protocol and Oracle database is deployed as container database with dNFS enabled.
