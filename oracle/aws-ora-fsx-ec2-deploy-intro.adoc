...
video::b1a7bb05-caea-44a0-bd9a-b01200f372e9[panopto, title="Modernize your Oracle database with hybrid cloud in AWS and FSx ONTAP, Part1 - Use case and solution architecture", width=360]


// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_ora_fsx_ec2_deploy_intro.adoc
