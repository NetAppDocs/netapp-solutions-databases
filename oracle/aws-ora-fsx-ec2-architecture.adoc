...
image:aws-ora-fsx-ec2-arch.png[This image depicts a sample architecture diagram including the primary HA cluster - the standby HA cluster - management nodes - and related connecting nodes.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/aws_ora_fsx_ec2_architecture.adoc
