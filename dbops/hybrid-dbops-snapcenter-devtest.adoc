...
summary: The agility of public cloud, the time to value, and the cost savings are all meaningful value propositions for enterprises adopting the public cloud for database application development and testing effort.
keywords: hybrid cloud, database, solutions, devtest, workflow
---
= Workflow for devtest bursting to cloud
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
+
image:snapctr-ora-clone-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-002.png["Figure showing input/output dialog or representing written content"]

. Toggled to the mirrored backups view by clicking mirrored backups. The secondary mirror backup(s) is then displayed.
+
image:snapctr-ora-clone-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-004.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-ora-clone-005.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:snapctr-ora-clone-006.png["Figure showing input/output dialog or representing written content"]

. Choose a proper clone DB SID for a complete container database or CDB clone.
+
image:snapctr-ora-clone-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-011.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-ora-clone-012.png["Figure showing input/output dialog or representing written content"]

. Configure the SMTP server for email notification if desired.
+
image:snapctr-ora-clone-013.png["Figure showing input/output dialog or representing written content"]

. Clone summary.
+
image:snapctr-ora-clone-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-clone-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-clone-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-clone-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-clone-003.png["Figure showing input/output dialog or representing written content"]

. Choose a backup copy, and then click the Clone button to launch the Clone from Backup workflow.
+
image:snapctr-sql-clone-004-a.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-sql-clone-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-clone-005.png["Figure showing input/output dialog or representing written content"]

. Determine a recovery point either by a log backup time or by a specific date and time.
+
image:snapctr-sql-clone-006.png["Figure showing input/output dialog or representing written content"]

. Specify optional scripts to run before and after the cloning operation.
+
image:snapctr-sql-clone-007.png["Figure showing input/output dialog or representing written content"]

. Configure an SMTP server if email notification is desired.
+
image:snapctr-sql-clone-008.png["Figure showing input/output dialog or representing written content"]

. Clone Summary.
+
image:snapctr-sql-clone-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-clone-010.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_devtest.adoc
