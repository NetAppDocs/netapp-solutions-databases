...
image:storage-layout-sqlsvr-large.png["Figure showing input/output dialog or representing written content"]

The following figure shows the NetApp recommended storage layout for small or medium SQL Server database on LUNs.

image:storage-layout-sqlsvr-smallmedium.png["Figure showing input/output dialog or representing written content"]
...
image:storage-layout-oracle-typical.png["Figure showing input/output dialog or representing written content"]
...
image:storage-layout-oracle-dedicated.png["Figure showing input/output dialog or representing written content"]
...
image:storage-layout-oracle-shared.png["Figure showing input/output dialog or representing written content"]
...
include::_include/automation-rhel-centos-setup.adoc[]

Follow these instruction to set up your Ansible control node for Ubuntu or Debian machines: 

include::_include/automation-ubuntu-debian-setup.adoc[]


// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_prereq_onprem.adoc
