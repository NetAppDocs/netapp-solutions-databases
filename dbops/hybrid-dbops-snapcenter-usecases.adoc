...
image:cvo-cloud-cost-comparision.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_usecases.adoc
