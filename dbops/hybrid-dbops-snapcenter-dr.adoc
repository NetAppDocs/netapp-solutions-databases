...
+
image:snapctr-ora-dr-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-dr-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-dr-003.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-ora-dr-004.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:snapctr-ora-dr-005.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-ora-dr-006.png["Figure showing input/output dialog or representing written content"]

. Select the last full database backup and click Clone to initiate the clone workflow.
+
image:snapctr-ora-dr-007.png["Figure showing input/output dialog or representing written content"]

. Select a unique clone DB ID on the host.
+
image:snapctr-ora-dr-008.png["Figure showing input/output dialog or representing written content"]

. Provision a log volume and mount it to the target DR server for the Oracle flash recovery area and online logs.
+
image:snapctr-ora-dr-009.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-ora-dr-010.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:snapctr-ora-dr-011.png["Figure showing input/output dialog or representing written content"]

. Select the credentials for the clone. Fill in the details of the Oracle home configuration on the target server.
+
image:snapctr-ora-dr-012.png["Figure showing input/output dialog or representing written content"]

. Specify the scripts to run before cloning. Database parameters can be adjusted if needed.
+
image:snapctr-ora-dr-013.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-dr-014.png["Figure showing input/output dialog or representing written content"]

. Configure the SMTP server for email notification if needed.
+
image:snapctr-ora-dr-015.png["Figure showing input/output dialog or representing written content"]

. DR clone summary.
+
image:snapctr-ora-dr-016.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-dr-016-a.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-dr-017.png["Figure showing input/output dialog or representing written content"]

. Configure the flash recovery area.
+
image:snapctr-ora-dr-018.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-dr-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-dr-002.png["Figure showing input/output dialog or representing written content"]

. Manually run a log backup to flush the last transaction to be replicated to secondary storage in the public cloud.
+
image:snapctr-sql-dr-003.png["Figure showing input/output dialog or representing written content"]

. Select the last full SQL Server backup for the clone.
+
image:snapctr-sql-dr-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-dr-005.png["Figure showing input/output dialog or representing written content"]

. Select all log backups to be applied.
+
image:snapctr-sql-dr-006.png["Figure showing input/output dialog or representing written content"]

. Specify any optional scripts to run before or after cloning.
+
image:snapctr-sql-dr-007.png["Figure showing input/output dialog or representing written content"]

. Specify an SMTP server if email notification is desired.
+
image:snapctr-sql-dr-008.png["Figure showing input/output dialog or representing written content"]

. DR clone summary. Cloned databases are immediately registered with SnapCenter and available for backup protection.
+
image:snapctr-sql-dr-009.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-sql-dr-010.png["Figure showing input/output dialog or representing written content"]

== Post DR clone validation and configuration for SQL

. Monitor clone job status.
+
image:snapctr-sql-dr-011.png["Figure showing input/output dialog or representing written content"]

. Validate that last transaction has been replicated and recovered with all log file clones and recovery.
+
image:snapctr-sql-dr-012.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_dr.adoc
