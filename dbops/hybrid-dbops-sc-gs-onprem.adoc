...
image:snapctr-admin-users.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-vmware-global.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-windows-host-001.png["Figure showing input/output dialog or representing written content"]

. After the plugin is installed on a Windows host, its Overall Status is shown as "Configure log directory."
+
image:snapctr-add-windows-host-002.png["Figure showing input/output dialog or representing written content"]

. Click the Host Name to open the SQL Server log directory configuration.
+
image:snapctr-add-windows-host-003.png["Figure showing input/output dialog or representing written content"]

. Click "Configure log directory" to open "Configure Plug-in for SQL Server."
+
image:snapctr-add-windows-host-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-windows-host-005.png["Figure showing input/output dialog or representing written content"]
+
[NOTE]
...
+
image:snapctr-add-windows-host-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-windows-host-007.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-add-windows-host-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-linux-host-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-linux-host-002.png["Figure showing input/output dialog or representing written content"]

. Click Submit to start the plugin installation. You are prompted to Confirm Fingerprint as shown below.
+
image:snapctr-add-linux-host-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-linux-host-004.png["Figure showing input/output dialog or representing written content"]

. Assign the newly added host to the proper database management user ID (in our case, oradba).
+
image:snapctr-add-linux-host-005.png["Figure showing input/output dialog or representing written content"]
+
image:snapctr-add-linux-host-006.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-resources-ora.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-resources-sql.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-add-windows-host-009.png["Figure showing input/output dialog or representing written content"]

image:snapctr-add-windows-host-010.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-add-windows-host-011.png["Figure showing input/output dialog or representing written content"]
...
On-premises cluster:
+
image:snapctr-cluster-replication-001.png["Figure showing input/output dialog or representing written content"]
+
Target CVO cluster:
+
image:snapctr-cluster-replication-002.png["Figure showing input/output dialog or representing written content"]

. With the intercluster LIFs configured, cluster peering and volume replication can be set up by using drag-and-drop in NetApp Cloud Manager. See link:hybrid-dbops-sc-gs-aws.html#aws-public-cloud["Getting Started - AWS Public Cloud"] for details.
+
...
+
image:snapctr-vol-snapmirror-000.png["Figure showing input/output dialog or representing written content"]

. Go to the Volumes tab. Select the database volume to be replicated and click Protect.
+
image:snapctr-vol-snapmirror-001.png["Figure showing input/output dialog or representing written content"]

. Set the protection policy to Asynchronous. Select the destination cluster and storage SVM.
+
image:snapctr-vol-snapmirror-002.png["Figure showing input/output dialog or representing written content"]

. Validate that the volume is synced between the source and target and that the replication relationship is healthy.
+
image:snapctr-vol-snapmirror-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-cvo-svm-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-add-cvo-svm-002.png["Figure showing input/output dialog or representing written content"]

. Assign the storage systems to SnapCenter database management user IDs as shown in <<3. SnapCenter host plugin installation>>.
+
image:snapctr-add-cvo-svm-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-policy-data-001.png["Figure showing input/output dialog or representing written content"]

. Click New to launch a new backup policy creation workflow or choose an existing policy for modification.
+
image:snapctr-ora-policy-data-002.png["Figure showing input/output dialog or representing written content"]

. Select the backup type and schedule frequency.
+
image:snapctr-ora-policy-data-003.png["Figure showing input/output dialog or representing written content"]

. Set the backup retention setting. This defines how many full database backup copies to keep.
+
image:snapctr-ora-policy-data-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-policy-data-005.png["Figure showing input/output dialog or representing written content"]

. Specify any optional script to run before and after a backup run.
+
image:snapctr-ora-policy-data-006.png["Figure showing input/output dialog or representing written content"]

. Run backup verification if desired.
+
image:snapctr-ora-policy-data-007.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-ora-policy-data-008.png["Figure showing input/output dialog or representing written content"]
...
. Click New to launch a new backup policy creation workflow, or choose an existing policy for modification.
+
image:snapctr-ora-policy-log-001.png["Figure showing input/output dialog or representing written content"]

. Select the backup type and schedule frequency.
+
image:snapctr-ora-policy-log-002.png["Figure showing input/output dialog or representing written content"]

. Set the log retention period.
+
image:snapctr-ora-policy-log-003.png["Figure showing input/output dialog or representing written content"]

. Enable replication to a secondary location in the public cloud.
+
image:snapctr-ora-policy-log-004.png["Figure showing input/output dialog or representing written content"]

. Specify any optional scripts to run before and after log backup.
+
image:snapctr-ora-policy-log-005.png["Figure showing input/output dialog or representing written content"]

. Specify any backup verification scripts.
+
image:snapctr-ora-policy-log-006.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-ora-policy-log-007.png["Figure showing input/output dialog or representing written content"]

==== Create a full database backup policy for SQL

. Log into SnapCenter with a database management user ID, click Settings, and then click Polices.
+
image:snapctr-sql-policy-data-001.png["Figure showing input/output dialog or representing written content"]

. Click New to launch a new backup policy creation workflow, or choose an existing policy for modification.
+
image:snapctr-sql-policy-data-002.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-policy-data-003.png["Figure showing input/output dialog or representing written content"]

. Set the backup retention period.
+
image:snapctr-sql-policy-data-004.png["Figure showing input/output dialog or representing written content"]

. Enable backup copy replication to a secondary location in cloud.
+
image:snapctr-sql-policy-data-005.png["Figure showing input/output dialog or representing written content"]

. Specify any optional scripts to run before or after a backup job.
+
image:snapctr-sql-policy-data-006.png["Figure showing input/output dialog or representing written content"]

. Specify the options to run backup verification.
+
image:snapctr-sql-policy-data-007.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-sql-policy-data-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-policy-log-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-policy-log-002.png["Figure showing input/output dialog or representing written content"]

. SQL server data backup policy defines the log backup retention; accept the defaults here.
+
image:snapctr-sql-policy-log-003.png["Figure showing input/output dialog or representing written content"]

. Enable log backup replication to secondary in the cloud.
+
image:snapctr-sql-policy-log-004.png["Figure showing input/output dialog or representing written content"]

. Specify any optional scripts to run before or after a backup job.
+
image:snapctr-sql-policy-log-005.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-sql-policy-log-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-rgroup-full-001.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-ora-rgroup-full-002.png["Figure showing input/output dialog or representing written content"]

. Add database resources to the resource group.
+
image:snapctr-ora-rgroup-full-003.png["Figure showing input/output dialog or representing written content"]

. Select a full backup policy created in section 7 from the drop-down list.
+
image:snapctr-ora-rgroup-full-004.png["Figure showing input/output dialog or representing written content"]

. Click the (+) sign to configure the desired backup schedule.
+
image:snapctr-ora-rgroup-full-005.png["Figure showing input/output dialog or representing written content"]

. Click Load Locators to load the source and destination volume.
+
image:snapctr-ora-rgroup-full-006.png["Figure showing input/output dialog or representing written content"]

. Configure the SMTP server for email notification if desired.
+
image:snapctr-ora-rgroup-full-007.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-ora-rgroup-full-008.png["Figure showing input/output dialog or representing written content"]

==== Create a resource group for log backup of Oracle

. Log into SnapCenter with a database management user ID, and navigate to the Resources tab. In the View drop-down list, choose either Database or Resource Group to launch the resource group creation workflow.
+
image:snapctr-ora-rgroup-log-001.png["Figure showing input/output dialog or representing written content"]

. Provide a name and tags for the resource group. You can define a naming format for the Snapshot copy and bypass the redundant archive log destination if configured.
+
image:snapctr-ora-rgroup-log-002.png["Figure showing input/output dialog or representing written content"]

. Add database resources to the resource group.
+
image:snapctr-ora-rgroup-log-003.png["Figure showing input/output dialog or representing written content"]

. Select a log backup policy created in section 7 from the drop-down list.
+
image:snapctr-ora-rgroup-log-004.png["Figure showing input/output dialog or representing written content"]

. Click on the (+) sign to configure the desired backup schedule.
+
image:snapctr-ora-rgroup-log-005.png["Figure showing input/output dialog or representing written content"]

. If backup verification is configured, it displays here.
+
image:snapctr-ora-rgroup-log-006.png["Figure showing input/output dialog or representing written content"]

. Configure an SMTP server for email notification if desired.
+
image:snapctr-ora-rgroup-log-007.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-ora-rgroup-log-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-rgroup-full-001.png["Figure showing input/output dialog or representing written content"]

. Select the database resources to be backed up.
+
image:snapctr-sql-rgroup-full-002.png["Figure showing input/output dialog or representing written content"]

. Select a full SQL backup policy created in section 7.
+
image:snapctr-sql-rgroup-full-003.png["Figure showing input/output dialog or representing written content"]

. Add exact timing for backups as well as the frequency.
+
image:snapctr-sql-rgroup-full-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-rgroup-full-005.png["Figure showing input/output dialog or representing written content"]

. Configure the SMTP server for email notification if desired.
+
image:snapctr-sql-rgroup-full-006.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-sql-rgroup-full-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-rgroup-log-001.png["Figure showing input/output dialog or representing written content"]

. Select the database resources to be backed up.
+
image:snapctr-sql-rgroup-log-002.png["Figure showing input/output dialog or representing written content"]

. Select a SQL log backup policy created in section 7.
+
image:snapctr-sql-rgroup-log-003.png["Figure showing input/output dialog or representing written content"]

. Add exact timing for the backup as well as the frequency.
+
image:snapctr-sql-rgroup-log-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:snapctr-sql-rgroup-log-005.png["Figure showing input/output dialog or representing written content"]

. Configure the SMTP server for email notification if desired.
+
image:snapctr-sql-rgroup-log-006.png["Figure showing input/output dialog or representing written content"]

. Summary.
+
image:snapctr-sql-rgroup-log-007.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-job-status-sql.png["Figure showing input/output dialog or representing written content"]
...
image:snapctr-job-status-ora.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_getting_started_onprem.adoc
