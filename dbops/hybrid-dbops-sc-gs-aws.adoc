...
+
image:cloud-central-login-page.png["Figure showing input/output dialog or representing written content"]

. After you log in, you should be taken to the Canvas.
+
image:cloud-central-canvas-page.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-026.png["Figure showing input/output dialog or representing written content"]

. If no connector has been created, a pop-up appears asking you to create a connector.
+
image:cloud-central-add-conn-001.png["Figure showing input/output dialog or representing written content"]

. Click Lets Start, and then choose AWS.
+
image:cloud-central-add-conn-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-conn-004.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-conn-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-conn-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-conn-007.png["Figure showing input/output dialog or representing written content"]

. Review the information on the summary page and click Add to deploy the connector.
+
image:cloud-central-add-conn-008.png["Figure showing input/output dialog or representing written content"]

. The connector now deploys using a cloud formation stack. You can monitor its progress from Cloud Manager or through AWS.
+
image:cloud-central-add-conn-009.png["Figure showing input/output dialog or representing written content"]

. When the deployment is complete, a success page appears.
+
image:cloud-central-add-conn-010.png["Figure showing input/output dialog or representing written content"]

==== Deploy Cloud Volumes ONTAP

. Select AWS and the type of deployment based on your requirements.
+
image:cloud-central-add-we-001.png["Figure showing input/output dialog or representing written content"]

. If no subscription has been assigned and you wish to purchase with PAYGO, choose Edit Credentials.
+
image:cloud-central-add-we-002.png["Figure showing input/output dialog or representing written content"]

. Choose Add Subscription.
+
image:cloud-central-add-we-003.png["Figure showing input/output dialog or representing written content"]

. Choose the type of contract that you wish to subscribe to. I chose Pay-as-you-go.
+
image:cloud-central-add-we-004.png["Figure showing input/output dialog or representing written content"]

. You are redirected to AWS; choose Continue to Subscribe.
+
image:cloud-central-add-we-005.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-006.png["Figure showing input/output dialog or representing written content"]

. You are redirected to Cloud Central where you must name your subscription and assign it to your Cloud Central account.
+
image:cloud-central-add-we-007.png["Figure showing input/output dialog or representing written content"]

. When successful, a check mark page appears. Navigate back to your Cloud Manager tab.
+
image:cloud-central-add-we-008.png["Figure showing input/output dialog or representing written content"]

. The subscription now appears in Cloud Central. Click Apply to continue.
+
image:cloud-central-add-we-009.png["Figure showing input/output dialog or representing written content"]
...
.. AWS tags (Optional)
+
image:cloud-central-add-we-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-013.png["Figure showing input/output dialog or representing written content"]

. Choose the connection methods for the nodes as well as the mediator.
+
image:cloud-central-add-we-014.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-015.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-016.png["Figure showing input/output dialog or representing written content"]

. Choose whether to enable AWS managed encryption or AWS KMS to encrypt the ONTAP root, boot, and data disks.
+
image:cloud-central-add-we-017.png["Figure showing input/output dialog or representing written content"]

. Choose your licensing model. If you don't know which to choose, contact your NetApp representative.
+
image:cloud-central-add-we-018.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-019.png["Figure showing input/output dialog or representing written content"]

. Optionally, create a volume. This is not required, because the next steps use SnapMirror, which creates the volumes for us.
+
image:cloud-central-add-we-020.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-021.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-022.png["Figure showing input/output dialog or representing written content"]

. You can monitor the progress by navigating to the Timeline.
+
image:cloud-central-add-we-023.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-024.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-add-we-025.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-001.png["Figure showing input/output dialog or representing written content"]
+
Select Enable.
+
image:cloud-central-replication-002.png["Figure showing input/output dialog or representing written content"]
+
Or Options.
+
image:cloud-central-replication-003.png["Figure showing input/output dialog or representing written content"]
+
Replicate.
+
image:cloud-central-replication-004.png["Figure showing input/output dialog or representing written content"]

. If you did not drag and drop, choose the destination cluster to replicate to.
+
image:cloud-central-replication-005.png["Figure showing input/output dialog or representing written content"]

. Choose the volume that you'd like to replicate. We replicated the data and all log volumes.
+
image:cloud-central-replication-006.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-007.png["Figure showing input/output dialog or representing written content"]

. Select the destination volume name: we chose `[source_volume_name]_dr`.
+
image:cloud-central-replication-008.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-009.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-010.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-011.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-012.png["Figure showing input/output dialog or representing written content"]
...
+
image:cloud-central-replication-013.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_getting_started_aws.adoc
