...
link:hybrid-dbops-sc-prereq-onprem.html[On Premises]

link:hybrid-dbops-sc-prereq-cloud.html[Public Cloud]


// NetApp Solutions restructuring (jul 2025) - renamed from databases/hybrid_dbops_snapcenter_prerequisite.adoc
